    ...
    <View style={styles.container} >
      <View style={styles.Gem} name="side_open">
        <Image style={styles.Gemph} source={require('../img/page3-0.jpg')} />
          ...
          <TouchableOpacity onPress={()=>navigation.navigate('CC')} style={styles.GemphQQ1}>

            
            <Image style={styles.GemphQQ} source={require('../img/page3-3.png')} />
            </TouchableOpacity>

        

        <Image style={styles.GemphWW} source={require('../img/page3-2.png')} />
      </View>
